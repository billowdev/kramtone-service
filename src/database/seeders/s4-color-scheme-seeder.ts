...
module.exports = {
	up: async (queryInterface: QueryInterface) => {
		...
		const colorSchemeData: Array<ColorSchemeType> = [
			...
			{ id: "SK1-85", name_en: "Light Blue", name_th: "ฟ้าอ่อน", hex: "#74ADC8", },
			...
			{ id: "SK5-51", name_en: "Deep Blue", name_th: "น้ำเงินเข้ม", hex: "#032352", },
			{ id: "SK5-13", name_en: "Deep Blue", name_th: "น้ำเงินเข้ม", hex: "#061D49", },
			...
			{ id: "SK5-108", name_en: "Deep Blue", name_th: "น้ำเงินเข้ม", hex: "#001F58", },
